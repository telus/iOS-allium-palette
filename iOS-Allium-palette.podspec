...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of iOS-Allium-palette.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/20618497/iOS-Allium-palette'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '20618497' => 'akshay.pandey@telus.com' }
  s.source           = { :git => 'https://github.com/20618497/iOS-Allium-palette.git', :tag => s.version.to_s }
